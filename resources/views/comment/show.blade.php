...
<div class="container-fluid">
   <div class="">
       <div class="mx-auto" style="max-width:800px">
           <h1 style="color:#f0f8ff; text-align:center; font-size:2.5em; padding:24px 0px; font-weight:bold;">{{$item->name}}</h1>
           <div class="">
                <!--商品一覧を出したい-->
                ...
                <!--コメント一覧を表示する-->
            <div class="">
                    <h1 style="color:#f0f8ff; text-align:center; font-size:2.5em; padding:24px 0px; font-weight:bold;">{{$item->name}}のコメント</h1>
            </div>
